...
raw = mne.read_epochs(raw_file , preload=True, verbose=False)
...
ica.plot_sources(raw.pick_types(meg=True, eeg=False, eog=True, ecg=False, ref_meg=False))

sp.Popen(["gedit", str(comp_ICA_json_path)], stdout=sp.DEVNULL, stderr=sp.DEVNULL)